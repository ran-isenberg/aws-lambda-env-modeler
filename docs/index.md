---
title: Homepage
description: AWS Lambda Environment Variables Modeler - Python library for validating and managing environment variables in AWS Lambda functions
---
## **AWS Lambda Environment Variables Modeler**
...
It leverages the power of [Pydantic](https://docs.pydantic.dev/latest/){:target="_blank" rel="noopener"} models to define the expected structure and types of the environment variables.
